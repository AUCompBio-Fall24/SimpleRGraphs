...
This tutorial package is being shared with you in **source** format, which means that editing/moving files will disrupt functionality of the code. **If you have this issue, re-install the package from Github.**  
...
```{r subset-ind5-hint}
#remember before we printed the first few lines of the file to get an idea of how it was formatted?
head(ind5)
#this should help you figure out how to submit for rows where Indiv is 5.
```
...
barplot(as.matrix(tresages), main="Tree Height", ylab= "Height (Meters)",
   beside=TRUE, col=rainbow(16), ylim = c(0,max(tresages)))
...
After a quick quiz below, return to the **Purpose** tab and try out your new skills for your upcoming lab assignment. 
